      ...
      <div className="max-w-7xl mx-auto grid gap-8 md:grid-cols-3">
        {contactInfo.map((item, index) => (
          ...
          >
            {/* Icon */}
            <motion.div
              className="flex items-center justify-center mb-6 text-green-400"
              variants={{
                initial: { rotateY: 0 },
                hover: { rotateY: 180 },
              }}
            ...
            {/* Title */}
            <h3 className="text-lg font-semibold mb-4 group-hover:text-[#FFF] transition-colors duration-500">
              {item.title}
            </h3>
            ...
            {item.details.map((line, i) => (
              <p
                key={i}
                className="text-gray-300 group-hover:text-[#FFF] transition-colors duration-500"
              >
                {line}
              </p>
            ))}
