  ...
  return (
    <section className="relative bg-[#0c2c2c] text-white py-16">
      <div className="max-w-7xl mx-auto px-6 grid md:grid-cols-2 gap-12 items-center">
        ...
        <div className="relative bg-[#093d3d] rounded-lg p-8 shadow-lg">
          ...
          <form className="space-y-4">
            ...
            {/* Service Dropdown */}
            <select className="w-full p-3 rounded-md bg-transparent border border-gray-600 text-gray-400 focus:outline-none">
